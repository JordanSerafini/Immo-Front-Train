...
export default function LayoutButton({
  ...
  return (
    <button
      ...
      type="button"
      className="hidden px-4 py-2 font-semibold duration-150 rounded-lg shadow-md lg:block bg-secondary-50 hover:scale-105 focus:ring-2 ring-accent-300 ring-offset-2"
    >
